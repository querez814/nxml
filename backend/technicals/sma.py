...
router = APIRouter()
@router.get("/smas/{ticker}")
def daily_smas(ticker:str):
    url_20 =  f"https://www.alphavantage.co/query?function=SMA&symbol={ticker}&interval=daily&time_period=20&series_type=close&apikey={av_api}"
    url_50 =  f"https://www.alphavantage.co/query?function=SMA&symbol={ticker}&interval=daily&time_period=50&series_type=close&apikey={av_api}" 
    url_200 =  f"https://www.alphavantage.co/query?function=SMA&symbol={ticker}&interval=daily&time_period=200&series_type=close&apikey={av_api}"

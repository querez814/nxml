<script lang="ts">
	...
	import DailyMovers from '$lib/components/market/DailyMovers.svelte';
		...
		<div class="container mx-auto flex min-h-screen flex-col px-4 py-8">
										...
										<div class="flex gap-4">
											<div class="hidden sm:block">
												<img
													src={news.image_url}
													alt={news.title}
													class="h-24 w-24 rounded-lg object-cover transition-transform group-hover:scale-105"
												/>
											</div>
			...
			<footer class="mt-8">
				...
				<p class="mt-4 text-center text-sm text-muted-foreground">
					Start with any ticker symbol - e.g., "AAPL", "MSFT", "TSLA" 🚀
				</p>
			</footer>
		</div>
	</div>

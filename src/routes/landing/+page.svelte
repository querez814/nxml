	...
	<header class={`navbar ${isScrolled ? 'is-scrolled' : ''}`}>
		<div class="navbar-inner">
			...
			<nav class="desktop-nav" aria-label="Primary">
				...
				{/each}
				<a class="cta-link" href="/app">Click here to enter DDP</a>
			</nav>
		...
		{#if isMobileMenuOpen}
			<nav id="mobile-nav" class="mobile-nav" aria-label="Mobile">
				...
				{/each}
				<a class="cta-link" href="/app" onclick={closeMobileMenu}>Click here to enter DDP</a>
			</nav>
		{/if}
	</header>
	...
	<footer class="footer">
		<div class="footer-inner">
			...
			<nav aria-label="Footer">
				...
				<a href="/app">Click here to enter DDP</a>
			</nav>
		</div>
	</footer>
</div>

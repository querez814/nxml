            ...
            "
					...
					<thead class="sticky top-0 z-10 bg-gray-700 text-sm uppercase tracking-wider">
						<tr>
							...
							<th class="px-4 py-3">Return on Capital Employed </th>
							<th class="px-4 py-3"> Cash Flow Adequacy Ratio</th>
							<th class="px-4 py-3"> Capital Expenditures Ratio</th>
							<th class="px-4 py-3"> Change in Working Capital</th>
						</tr>
					</thead>
					...
					<tbody>
						{#each quarters as row}
							<tr class="border-b border-gray-600/40 hover:bg-gray-800/40">
								...
								<td class="px-4 py-3">{row.roce}</td>
								<td class="px-4 py-3">{row.cfa_ratio}</td>
								<td class="px-4 py-3">{row.capex_ratio}</td>
								<td class="px-4 py-3">{row.change_working_capital}</td>
							</tr>
						{/each}
					</tbody>
				</table>
